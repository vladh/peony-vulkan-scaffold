...
static constexpr VkDescriptorPoolSize GEOMETRY_DESCRIPTOR_POOL_SIZES[] = {
...
static constexpr VkDescriptorSetLayoutBinding GEOMETRY_DESCRIPTOR_BINDINGS[] = {
...
static constexpr u32 GEOMETRY_N_DESCRIPTORS = LEN(GEOMETRY_DESCRIPTOR_POOL_SIZES);
...
static void init_geometry_stage_swapchain(VkState *vk_state, VkExtent2D extent) {
  // Descriptors
  {
    ...
    auto const pool_info = vkutils::descriptor_pool_create_info(N_PARALLEL_FRAMES, GEOMETRY_N_DESCRIPTORS,
      GEOMETRY_DESCRIPTOR_POOL_SIZES);
    ...
    range (0, N_PARALLEL_FRAMES) {
      ...
      vkUpdateDescriptorSets(vk_state->device, GEOMETRY_N_DESCRIPTORS, descriptor_writes, 0, nullptr);
    }
  }
...
static void init_geometry_stage(VkState *vk_state, VkExtent2D extent) {
  ...
  {
    auto const layout_info = vkutils::descriptor_set_layout_create_info(GEOMETRY_N_DESCRIPTORS,
      GEOMETRY_DESCRIPTOR_BINDINGS);
